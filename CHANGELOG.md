...
*Enhancements*
- `krane deploy` and `krane render` allow deploy filenames given from stdin stream with given `--stdin` argument. ([#630](https://github.com/Shopify/kubernetes-deploy/pull/630))
