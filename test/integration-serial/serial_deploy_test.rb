...
class SerialDeployTest < Krane::IntegrationTest
  ...
  # def test_resources_with_side_effect_inducing_webhooks_are_not_server_side_dry_run
  #   Krane::Kubectl.any_instance.expects(:run).with("get", "mutatingwebhookconfigurations", "-ojson",
  #     use_namespace: false, raise_if_not_found: true).returns({})
